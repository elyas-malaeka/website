                                        ...
                                        <div class="col-md-6">
                                            <div class="blog-card">
                                                <div class="blog-card__image-wrapper">
                                                    <?php if (!empty($posts[$i]['main_image'])): ?>
                                                        <img class="blog-card__image" src="assets/images/blog/<?php echo $posts[$i]['main_image']; ?>" 
                                                            alt="<?php echo htmlspecialchars($lang == 'en' ? $posts[$i]['title_en'] : $posts[$i]['title']); ?>">
                                                    <?php else: ?>
                                                        <img class="blog-card__image" src="assets/images/blog/default.jpg" alt="No Image Available">
                                                    <?php endif; ?>
                                                    <a href="post.php?id=<?php echo $posts[$i]['id']; ?><?php echo $isRtl ? '&lang=fa' : ''; ?>" class="blog-card__image-link"></a>
